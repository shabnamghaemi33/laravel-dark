                ...
                <ul class="">
                    <li class="w-20 h-14 flex items-center border-r-4 border-indigo-700">
                        <a href="" class="mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-400 hover:text-indigo-700 " width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity sidebar-svg">
            ...
            <div class="">
                <ul class="">
                    <li class="w-14 h-14 flex items-center">
                        <a href="#" class="mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto text-gray-700 active" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                        </a>
                    </li>
                    <li class="w-14 h-14 flex items-center">
                        <a href="#" class="mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto text-gray-700" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                        </a>
                    </li>
                    <li class="w-14 h-14 flex items-center">
                        <a href="#" class="mx-auto">
                ...
                <ul class="leading-10">
                    <li class="mb-5">
                        <div class="flex flex-row-reverse">
                            <a href="#" class="flex justify-between mr-4 text-gray-500 hover:text-gray-900 text-base font-medium w-4/5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="relative text-gray-500 rotate-180 transform" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                        ...
                        <ul class="leading-8 hidden">
                            <li class="">
                                <a href="#" class="flex flex-row-reverse mr-8 text-gray-500 hover:text-gray-900 focus:text-indigo-500 items-center">
                                    <i class="fa fa-user ml-4"></i> شخصی: اول
                                </a>
                            </li>
                            <li class="">
                                <a href="#" class="flex flex-row-reverse mr-8 items-center hover:text-gray-900 focus:text-indigo-500 text-gray-500">
                    ...
                    <li class="mb-5">
                        <div class="flex flex-row-reverse">
                            <a href="#" class="flex justify-between mr-4 text-gray-500 hover:text-gray-900 text-base font-medium w-4/5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="relative text-gray-500 transform rotate-180" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                    <polyline points="9 18 15 12 9 6"></polyline>
                                </svg>
                    ...
                    <div class="header flex justify-between my-4">
                        <div class="">
                            <span class="relative inline-block items-center transition-all cursor-pointer rounded-full bg-transparent hover:bg-white w-8 h-8">
                                <a href="#" class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mt-2" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                                </a>
                            </span>
                            <span class="relative inline-block items-center ml-4 transition-all cursor-pointer rounded-full bg-transparent hover:bg-white w-8 h-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mt-2" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
                                <span class="animate-ping"></span>
                            </span>
                            <span class="relative inline-block ml-4 items-center transition-all cursor-pointer rounded-full bg-transparent hover:bg-white w-8 h-8">
                                <a href="#" class="">
                                    <img src="./img/logo.svg" width="16" height="16" alt="flag" class="mx-auto mt-2" />
                                </a>
                            </span>
                            <span class="relative inline-block ml-4 items-center transition-all cursor-pointer bg-transparent hover:bg-white rounded-full w-8 h-8">
                                <a href="#" class="">
